...
?>
<form action="<?php echo JRoute::_('index.php?option=com_ashs&view=orders'); ?>" method="post" name="adminForm" id="adminForm">
	<div id="j-sidebar-container" class="span2">
		<?php echo $this->sidebar; ?>
	</div>
	<div id="j-main-container" class="span10">	
 <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => $activetab)); ?>
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'searchbyorder', JText::_('COM_ASHS_FIELD_TO_EXPORT', true)); ?>				
		<!--Search by Order -->
			<div class="form-horizontal">		
				<div class="select">
					<select name="export_choose" class="export_choose">
						<option value="selected" <?php echo ($selected == 1)?('selected="1"'):'';?>><?php echo JText::_("COM_ASHS_EXPORT_EXPORT_SELECTED_ROW");?> (<?php echo $countcids;?>) </option>
						<option value="search" <?php echo ($selected == 2)?('selected="1"'):'';?>><?php echo JText::_("COM_ASHS_EXPORT_EXPORT_SEARCH_ROW");?> (<?php echo $countitems;?>)</option>
						<option value="all" <?php echo ($selected == 3)?('selected="1"'):'';?>><?php echo JText::_("COM_ASHS_EXPORT_EXPORT_ROW");?> (<?php echo $countallitems;?>)</option>
					</select>
				</div>
			...
			<thead>
				<tr>
					<th width="100"><?php echo JText::_("COM_ASHS_EXPORT_EXPORT_COLUMN_ORDER");?></th>
					<th width="200"><input type="checkbox" class="selectall" style="margin-top: -2px;" checked="1"> <?php echo JText::_("COM_ASHS_EXPORT_EXPORT_COLUMN_EXPORT");?></th>
					<th><?php echo JText::_("COM_ASHS_EXPORT_EXPORT_COLUMN_SUBMISSION");?></th>
					<th></th>
				</tr>
			</thead>
			...
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_ORDER_ID");?></td>
				<td></td>
			</tr>
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_ORDER_NO");?></td>
				<td></td>
			</tr>			
			...
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_PRODUCT_NAME");?></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_SKU");?></td>
				<td></td>
			</tr>
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_ORDER_DATE");?></td>
				<td>
					<div  class="">
			...
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_PRODUCT_PRICE");?></td>
				<td></td>
			</tr>
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_QTY");?></td>
				<td></td>
			</tr>
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_PRODUCT_STOCK");?></td>
				<td></td>
			</tr>
			...
			<!--<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_SECRET_KEY");?></td>
				<td></td>
			</tr>-->
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_BILL_TO");?></td>
				<td></td>
			</tr>
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_SHIP_TO");?></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_ORDER_COUPON");?></td>
				<td></td>
			</tr>
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_DISCOUNT");?></td>
				<td></td>
			</tr>
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_ORDER_STATUS");?></td>
				<td></td>
			</tr>
			...
			<!--<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_TOTAL_TAX");?></td>
				<td></td>
			</tr>-->
			...
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_ORDER_TOTAL");?></td>
				<td></td>
			</tr>
			<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_PAYMENT_METHOD");?></td>
				<td></td>
			</tr>
			<tr>
				<td><span class="sortable-handler" style="cursor: move;"><span class="icon-menu"></span></span><span class="orderno">18</span></td>
				<td><input class="checkbox" type="checkbox" name="export[]" checked="true"  value="shipping_method" date-toggle="shipping_method" ></td>
				<td><?php echo JText::_("COM_ASHS_EXPORT_SHIPPING_METHOD");?></td>
				<td></td>
			</tr>
			...
			<!--<tr>
				...
				<td><?php echo JText::_("COM_ASHS_EXPORT_COMMENT");?></td>
				<td></td>
			</tr>-->
			</tbody>
			</table>
   ...
   <!--Search by date -->
   <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'searchbydate', JText::_('COM_ASHS_CSV_OPTION')); ?>
		<div class="form-horizontal">			
			<div class="control-group">
				<span class="control-label">
				  <label id="filter_include_columnheader-lbl" for="filter_include_columnheader" class="hasTooltip" title="" data-original-title="Include Column Headers"><?php echo JText::_("COM_ASHS_EXPORT_INCLUDE_COLUMN");?> :</label>
				</span>
				<div class="controls">
			...
			<div class="control-group">
				<span class="control-label">
				  <label id="filter_delimiter-lbl" for="filter_delimiter" class="hasTooltip" title="" data-original-title="Delimiter">	<?php echo JText::_("COM_ASHS_EXPORT_DELIMITER");?>:</label>
				</span>
				<div class="controls">
			...
			<div class="control-group">
				<span class="control-label">
				  <label id="filter_enclosure-lbl" for="filter_enclosure" class="hasTooltip" title="" data-original-title="Field Enclosure"><?php echo JText::_("COM_ASHS_EXPORT_FIELD_ENCLOSURE");?>:</label>
				</span>
				<div class="controls">
  ...
  <?php echo JHtml::_('bootstrap.endTab'); ?>
<br> 
<button  type="button" id="submit_button" class="btn btn-warning" title="<?php echo JText::_('COM_ASHS_EXPORT_BUTTON'); ?>"><span class="icon-download"></span>
	<?php echo JText::_('COM_ASHS_EXPORT_BUTTON'); ?>
</button>
<hr>	
</div>
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title"><?php echo JText::_("COM_ASHS_EXPORT_PREVIEW");?></h4>
		  </div>
		...
		<div class="modal-footer">
			...
			<button  type="submit" id="submit_buttons" class="btn btn-warning" title="<?php echo JText::_('COM_ASHS_EXPORT_BUTTON'); ?>"><span class="icon-download"></span>
				<?php echo JText::_('COM_ASHS_EXPORT_BUTTON'); ?>
			</button>  
...
<div class="loader" style="display:none;">
	<div class="loader-inner">
		<img src="<?php echo JURI::root();?>administrator/components/com_ashs/assets/images/loader.gif">
	</div>
</div>
<style>
